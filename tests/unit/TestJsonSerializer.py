...
class TestJsonSerializer(unittest2.TestCase):
    ...
    def test_PrimitiveSerilization(self):
        pass
    
    def test_PrimitiveDeserilization(self):
        pass
    
    def test_SimpleObjectSerilizationDeserilization(self):
        pass
    
    def test_NestedObjectSerilizationDeserilization(self):
        pass
